...
class RunTiime():
    ...
    def buttons(self):
        ...
        # Dashboard
        self.app.reload_dashboard_btn.clicked.connect(lambda: self.process.reload_dashboard())
        self.app.search_date_payments.clicked.connect(lambda: self.process.search_payments_by_date())
